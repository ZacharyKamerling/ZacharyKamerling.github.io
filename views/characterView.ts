...
export class CharacterView {
    ...
    private renderPageContainer() {
        ...
        container.innerHTML = `
            <div id="tabs-bar" style="display: flex; justify-content: center; gap: 0.4em; padding: 0.5em 0; flex-wrap: wrap; background: rgba(0, 0, 0, 0.9); border-bottom: 1px solid #444; flex-shrink: 0;">
